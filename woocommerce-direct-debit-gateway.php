...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
    ...
    function init_direct_debits_gateway()
    {
        ...
        class WC_Gateway_Direct_Debits extends WC_Payment_Gateway
        {
            ...
            public function payment_fields()
            {
                ...
                <div class="row-form">
                    <label for="dg_iban_number"><?php _e('Cuenta corriente IBAN:', 'dg_wc_directdebit'); ?></label>
    ...
    {
        add_meta_box('direct-debit-metabox', 'Información pago por domiciliación. IBAN y BIC.', 'directdebit_information_render', 'shop_order', 'normal', 'default');
    }
    ...
    function directdebit_information_render()
    {
        ...
        if ($dg_iban_number != "") {
            echo "<h4>IBAN: " . $dg_iban_number . "</h4>";
        }

        if ($dg_bic_number != "") {
            echo "<h4>BIC: " . $dg_bic_number . "</h4>";
        }
    }
}
